"""Unit tests for Newton MVP core (fitting / perception / pipeline)."""
...
class TestFitting(unittest.TestCase):
    ...
    def test_selects_uniform_acceleration(self) -> None:
        ...
        result = fit_and_select(
            ...
            t_test,
            x_test,
            test_mse_threshold=1.0,  # generous for smoke
        )
        self.assertIsNotNone(result["winner"])
        self.assertEqual(result["winner"]["formula_id"], "uniform_acceleration")
    ...
    def test_gate_failure_sets_fallback_flag(self) -> None:
        ...
        # Pure noise: no formula should pass a tiny threshold.
